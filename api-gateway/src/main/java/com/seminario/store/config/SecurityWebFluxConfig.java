...
//    }
    ...
    SecurityWebFilterChain springWebFilterChain(ServerHttpSecurity http) throws Exception {
        http
                ...
                .authorizeExchange(ex -> ex.pathMatchers(HttpMethod.POST, "/api/user-management/users" ).permitAll()
                        .pathMatchers( "/api/user-management/roles" ).permitAll()
                        .pathMatchers( "/api/products-management/store-types" ).permitAll()
                        .pathMatchers( "/api/products-management/product-categories" ).permitAll()
                        .pathMatchers( "/api/delivery-management/order-statuses" ).permitAll()
                        )
                .authorizeExchange()
